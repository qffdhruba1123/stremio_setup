...
- Comet
- Debrid Search
- **Comment**: This is useful in cases when a scraper addon occasionally request the file on Real-Debrid but throws an error when starting the stream. This addon will pickup that file, and you can use the link generated by  this add on to stream instead of the link by the scraper.
