...
* You can see all the files you have streamed [here](https://real-debrid.com/downloads).
...
* You can set up [Comet](https://comet.elfhosted.com/configure) and [MediaFusion](https://mediafusion.elfhosted.com/configure) as alternatives to Torrentio to provide you with stream links. **Make sure to set them up with your Real-Debrid API Key.** This will ensure you still get stream links even if Torrentio is down.
